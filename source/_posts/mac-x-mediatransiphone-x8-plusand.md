---
title: Mac X Mediatransの更新：iPhone X/8 Plusをサポートしたデータバックアップ&復元機能に加えられた改良点
date: 2024-08-26T16:30:33.698Z
updated: 2024-08-27T16:30:33.698Z
categories:
  - macxdvd
thumbnail: https://thmb.techidaily.com/7e02bd572984315c91b0feee5bb97c59ecfef3acd51a935224f88b492a26dbad.jpg
---

## Mac X Mediatransの更新：iPhone X/8 Plusをサポートしたデータバックアップ&復元機能に加えられた改良点

## iPhone XとiPhone 8/8 Plusデータバックアップ＆復元に対応するソフトMacX Mediatransの新バージョンをリリース！

2017年10月17日

**Digiarty社はiPhone XとiPhone 8/8 Plusの登場に合わせ、Digiarty 社の大人気iPhoneデータ転送＆管理ソフトMacX MediaTransの最新バージョンをリリースしました。最新バージョンでは、iPhone XとiPhone 8/8 Plusへ機種変更する際に、データのバックアップと復元できます。**

![](https://www.macxdvd.com/press-room/image/macx-dvd-ripper-pro-upgrade-2017-jp.jpg)

Digiarty社はiPhone XとiPhone 8/8 Plusの登場に合わせ、Digiarty 社の大人気iPhoneデータ転送＆管理ソフト[**MacX MediaTrans**](https://tools.techidaily.com/macxdvd/products/)の最新バージョンをリリースしました。新バージョンでは、iPhone XとiPhone 8/8 Plus、iOS 11にも対応し、旧iPhoneからデータをバックアップして、新iPhone XまたはiPhone 8/8 Plusに復元できます。

**MacX MediaTrans概要**

 MacX MediaTransはMacで動作するiOSデバイス向けのデータ転送＆管理ソフトです。iPhoneとMacの間で、音楽・ビデオ・写真・電子書籍・ボイスメモ・iTunes Uコンテンツなどのデータのやり取りが簡単にできます。

**MacX MediaTransでできること**
...
製品ページ：<https://www.macxdvd.com/mediatrans/index-jp.htm>

**iPhone XとiPhone 8/8 Plusに対応済みの人気ソフトも一斉アップデート！**

またDigiarty社の売れ筋ランキングNo.1のDVDコピーソフトMacX DVD Ripper Proと動画変換ソフトはiPhone X、iPhone 8とiPhone 8 Plusのプロファイルを追加し、これら3モデルに対応するようになりました。

**■MacX DVD Ripper Pro（DVDリッピングソフト）**

主な機能：iPhone 8/8 Plus・iPhone XにDVDを変換・編集、DVDをISOイメージ・DVDフォルダ・MPEGファイルに1:1無劣化コピー。[もっと詳しく知る＞＞](https://tools.techidaily.com/macxdvd/products/)  
[DVDをiPhone 8/8 Plus・iPhone Xに取り込む方法＞＞](https://tools.techidaily.com/macxdvd/products/)

**■MacX Video Converter Pro（動画変換ソフト）**

iPhone 8/8 Plus・iPhone Xに動画を変換・編集、YouTube動画ダウンロード、音楽付きスライドショー作成。[もっと詳しく知る＞＞](https://tools.techidaily.com/macxdvd/products/)
